...
TextQuery::QueryResult TextQuery::query(const string&str)
{
	return QueryResult(str, this);
}

TextQuery::QueryResult::QueryResult(const string&str, TextQuery*pt)
{
	word = str;
	sp = pt->whole_text;
...
ostream& print(ostream&os, TextQuery::QueryResult result)
{
